...
public class CentroDistribuicao {
    ...
    public int recebeAditivo(int qtdade) {
        ...
        if(qtdade + TanqueAditivo > MAX_ADITIVO) {
            int aux = TanqueAditivo;
            TanqueAditivo = MAX_ADITIVO;

            return MAX_ADITIVO - aux;
        }
    ...
    public int recebeGasolina(int qtdade) {
        ...
        if(qtdade + TanqueGasolina > MAX_GASOLINA) {
            int aux = TanqueGasolina;
            TanqueGasolina = MAX_GASOLINA;

            return MAX_GASOLINA - aux;
        }
    ...
    public int recebeAlcool(int qtdade) {
        ...
        if(qtdade + TanqueAlcool1*2 > MAX_ALCOOL) {
            int aux = TanqueAlcool1; 
            TanqueAlcool1 = MAX_ALCOOL/2;
            TanqueAlcool2 = MAX_ALCOOL/2;

            return MAX_ALCOOL - aux*2;
        }
    ...
    public enum TIPOPOSTO {COMUM, ESTRATEGICO, INVALIDO}
}
